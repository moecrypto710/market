    ...
    <>
      ...
      {!vrEnabled && (
        <div className="container mx-auto px-4 py-6">
          ...
          >
            {/* Background with arabesque patterns */}
            <div className="absolute inset-0 bg-gradient-to-br from-fuchsia-900/90 to-purple-900/90 overflow-hidden">
              ...
              {/* Glowing orbs */}
              <div className="absolute top-20 left-20 w-80 h-80 rounded-full bg-purple-500/20 filter blur-3xl animate-pulse-slow"></div>
              <div className="absolute bottom-10 right-10 w-60 h-60 rounded-full bg-fuchsia-500/20 filter blur-3xl animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
            </div>
