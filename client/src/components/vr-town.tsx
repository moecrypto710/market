...
const townStores: Store[] = [
  // Electronics District
  {
    ...
    color: "#5e35b1",
    icon: "laptop",
    description: "متجر متخصص في أحدث الإلكترونيات والأجهزة التقنية",
    isPopular: true
  },
  {
    id: 2,
    name: "مركز الهواتف الذكية",
    category: "electronics",
    ...
    color: "#3b82f6",
    icon: "smartphone",
    description: "متجر متخصص في الهواتف الذكية والأجهزة اللوحية"
  },
  {
    id: 3,
    ...
    color: "#8b5cf6",
    icon: "gamepad",
    description: "متجر ألعاب الفيديو وملحقاتها"
  },
  
  // Fashion District
  {
    id: 4,
    name: "بوتيك الأزياء العالمية",
    category: "clothing",
    ...
    color: "#ec4899",
    icon: "dress",
    description: "متجر للأزياء العالمية الراقية",
    isPopular: true
  },
  {
    id: 5,
    ...
    color: "#f43f5e",
    icon: "shoe",
    description: "متجر متخصص في الأحذية الرياضية من ماركات عالمية"
  },
  {
    id: 6,
    name: "متجر الإكسسوارات والمجوهرات",
    category: "clothing",
    ...
    color: "#eab308",
    icon: "gem",
    description: "متجر للإكسسوارات والمجوهرات الفاخرة"
  },
  
  // Travel District
  {
    id: 7,
    name: "وكالة السفر العالمية",
    category: "travel",
    ...
    color: "#0ea5e9",
    icon: "plane",
    description: "وكالة سفر متكاملة لجميع وجهات العالم",
    isPopular: true
  },
  {
    id: 8,
    name: "مركز حجوزات الفنادق",
    category: "travel",
    ...
    color: "#06b6d4",
    icon: "hotel",
    description: "خدمات حجز الفنادق العالمية بأفضل الأسعار"
  },
  {
    id: 9,
    name: "مركز الرحلات السياحية",
    category: "travel",
    position: { x: -5, y: 0, z: -18 },
    rotation: 5,
    size: "medium",
    ...
    color: "#0284c7",
    icon: "palm-tree",
    description: "متخصصون في الرحلات السياحية المميزة حول العالم"
  },
  
  // Food District
  {
    id: 10,
    name: "المطعم العربي الفاخر",
    category: "food",
    ...
    color: "#f97316",
    icon: "utensils",
    description: "مطعم يقدم أشهى المأكولات العربية الأصيلة"
  },
  {
    id: 11,
    name: "كافيه ومقهى الواحة",
    category: "food",
    ...
    color: "#a3e635",
    icon: "coffee",
    description: "مقهى عصري يقدم أجود أنواع القهوة"
  },
  
  // Luxury District
  {
    id: 12,
    name: "مركز المنتجات الفاخرة",
    category: "luxury",
    position: { x: 8, y: 0, z: 10 },
    rotation: -160,
    size: "large",
    ...
    color: "#fcd34d",
    icon: "crown",
    description: "متجر متخصص في المنتجات الفاخرة والهدايا المميزة"
  }
];
